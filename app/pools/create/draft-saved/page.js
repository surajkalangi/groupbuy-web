            ...
            <main className={styles.page}>
                <div className={styles.container}>
                    <div className={styles.card}>
                        ...
                        <h1 className={styles.title}>Pool Saved as Draft</h1>
                        <p className={styles.subtitle}>
                            You can find your draft in &quot;My Pools&quot; under Hosting Tab and publish it whenever you are ready.
                        </p>
                        ...
                        <div className={styles.actions}>
                            <Link href="/pools/my?tab=hosting" className={styles.primaryBtn}>Go to My Pools</Link>
                            <Link href="/feed" className={styles.outlineBtn}>Back to Home</Link>
                        </div>
                    </div>

                    <p className={styles.helpText}>
                        Need help with your pool? <Link href="/support" className={styles.supportLink}>Contact Community Support</Link>
                    </p>
                </div>
            </main>
            <BottomNav />
