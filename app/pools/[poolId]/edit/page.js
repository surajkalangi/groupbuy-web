...
export default function EditPoolPage() {
    ...
    const poolId = params.poolId || params.pitchId;
    const router = useRouter();
    const pitch = mockPitches.find(p => p.id === poolId) || mockPitches[0];
            ...
            <header className={styles.editHeader}>
                <div className={styles.editHeaderInner}>
                    <div className={styles.topBarLeft}>
                        ...
                        <h1 className={styles.topBarTitle}>Edit Pool</h1>
                    </div>
                    ...
                    <section className={styles.progressBanner}>
                        <div className={styles.progressSide}>
                            <div className={styles.progressHeadRow}>
                                <h2 className={styles.progressHeading}>Pool Progress</h2>
                            </div>
                    ...
                    {hasParticipants && (
                        <div className={styles.notificationBanner}>
                            ...
                            <p className={styles.notificationBannerText}>
                                <strong>Heads up:</strong> Any changes you save will be notified to all participants of this pool. Make sure your updates are accurate before saving.
                            </p>
                        </div>
                    )}
                        ...
                        <div className={styles.leftCol}>
                            ...
                            <section className={`${styles.card} ${styles.order1}`}>
                                ...
                                <div className={styles.fieldStack}>
                                    ...
                                    <div className={styles.field}>
                                        <label className={styles.label}>Pool Title</label>
                                        <input
                                            type="text"
                            ...
                            <section className={`${styles.card} ${styles.order4}`}>
                                <div className={styles.labelRow} style={{ marginBottom: '1rem' }}>
                                    <h3 className={styles.cardTitle} style={{ marginBottom: 0 }}>Pool Policies</h3>
                                    {hasParticipants && (
                                        <span className={styles.lockedBadge}>
                                            <span className="material-symbols-outlined" style={{ fontSize: '10px' }}>lock</span>
                                            LOCKED
                                    ...
                                    <div className={styles.policyInfoBox}>
                                        ...
                                        <p className={styles.policyInfoText}>
                                            {hasParticipants
                                                ...
                                                : 'A 2% platform processing fee is always applied on refunds. Cancellation fee applies when participants quit after the pool threshold is met but before the order is placed.'}
                                        </p>
                                    </div>
                                </div>
                            </section>
