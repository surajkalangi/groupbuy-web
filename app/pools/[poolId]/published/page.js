...
const NEXT_STEPS = [
    { icon: 'group_add', title: 'Members Join', desc: 'Your pool is now visible to clan members. They can join with one tap.' },
            ...
            <main className={styles.page}>
                <div className={styles.container}>
                    ...
                    <div className={styles.successHeader}>
                        ...
                        <h1 className={styles.successTitle}>Your Pool is Live! 🚀</h1>
                    ...
                    <div className={styles.summaryCard}>
                        <div className={styles.summaryImage}>
                            ...
                            <span className={styles.activeBadge}>ACTIVE POOL</span>
                        </div>
                    ...
                    <div className={styles.actions}>
                        <Link href={`/pools/${poolId}/host-dashboard`} className={styles.primaryBtn}>
