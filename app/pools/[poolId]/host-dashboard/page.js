            ...
            <div className={styles.page}>
                ...
                <aside className={styles.sidebar}>
                    <div className={styles.sidebarHeader}>
                        ...
                        <p className={styles.sidebarSub}>Managing 3 active pools</p>
                    </div>
                    <nav className={styles.sidebarNav}>
                        {[
                            { icon: 'dashboard', label: 'Overview', active: true },
                            { icon: 'group', label: 'Participants' },
                            { icon: 'receipt_long', label: 'Payouts' },
                    ...
                    <section className={styles.pitchHeader}>
                        <div>
                            <nav className={styles.breadcrumb}>
                                <Link href="/pools/my?tab=hosting" className={styles.breadcrumbLink}>My Pools</Link>
                        ...
                        <div className={styles.headerActions}>
                            <Link href={`/pools/${poolId}/edit`} className={styles.editBtn}>
