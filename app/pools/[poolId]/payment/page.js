...
function PaymentContent({ pitchId }) {
    ...
    return (
        <div className={styles.page}>
            <Navbar backHref={`/pools/${pitchId}`} />
            
            <main className={styles.main}>
                <div className={styles.header}>
                    <h1 className={styles.title}>Authorize Commitment</h1>
                    <p className={styles.subtitle}>Securing your spot in the pool.</p>
                </div>
                ...
                <div className={styles.card}>
                    ...
                    <div className={styles.pitchInfoRow}>
                        ...
                        <div className={styles.pitchDetails}>
                            <span className={styles.eyebrow}>ACTIVE POOL</span>
                    ...
                    <div className={styles.escrowBox}>
                        ...
                        <div className={styles.escrowTextContent}>
                            ...
                            <p className={styles.escrowText}>
                                Your funds will be <strong>blocked via UPI, NOT debited yet.</strong> Money is only released to the host once delivery is verified by the community. If the pool goal is not met, your mandate is automatically cancelled at no cost.
                            </p>
                        </div>
                    </div>
                    ...
                    <button 
                        ...
                        onClick={() => router.push(`/pools/${pitchId}/confirmation?qty=${qty}`)}
                    >
...
export default function PaymentPage({ params }) {
    ...
    const poolId = resolvedParams.poolId || resolvedParams.pitchId;
    return (
        <AuthGuard>
        <Suspense fallback={<div style={{ padding: '2rem', textAlign: 'center' }}>Loading payment details...</div>}>
            <PaymentContent pitchId={poolId} />
        </Suspense>
        </AuthGuard>
    );
}
