    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.headerText}>
                ...
                <p className={styles.subtext}>You&apos;ve successfully joined the community pool.</p>
            </div>
            ...
            <div className={styles.actionGroup}>
                <button className={styles.secondaryBtn} onClick={() => router.push(`/pools/${pitchId}`)}>
                    View Pool Details
                </button>
        ...
        <>
            ...
            <main className={styles.page}>
                <Suspense fallback={<div style={{ padding: '2rem', textAlign: 'center' }}>Loading confirmation...</div>}>
                    <ConfirmationContent pitchId={poolId} />
                </Suspense>
            </main>
        </>
        </AuthGuard>
