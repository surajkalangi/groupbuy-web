...
export default function JoinPool({ params }) {
                ...
                <div className={styles.container}>
                    ...
                    <div className={styles.productBanner}>
                        ...
                        <div className={styles.bannerOverlay}>
                            <span className={styles.bannerEyebrow}>CURRENT POOL</span>
                    ...
                    {pitch.pitchPolicies && (
                        <div className={styles.policyAgreement}>
                            <div className={styles.policyAgreementHeader}>
                                ...
                                <span className={styles.policyAgreementTitle}>Pool Policies</span>
                            </div>
                            ...
                            <p className={styles.policyConsent}>By joining, you agree to the host's pool policies.</p>
                        </div>
                    )}
                    ...
                    <button
                        ...
                        onClick={() => router.push(`/pools/${pitch.id}/payment?qty=${qty}`)}
                    >
                        Confirm & Pay
